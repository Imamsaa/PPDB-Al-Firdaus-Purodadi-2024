...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Gallery Sekolah</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?= base_url('/sekolah'); ?>">Home</a></li>
              <li class="breadcrumb-item active">Gallery Sekolah</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">GALLERY SEKOLAH</h3>
          </div>
              <!-- /.card-header -->
              <div class="card-body">
                <a href="<?= base_url('/sekolah/gallery/tambah'); ?>" class="btn btn-success"><i class="fas fa-plus"></i> TAMBAH FOTO GALLERY</a>
