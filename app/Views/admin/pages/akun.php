        ...
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">DATA CALON PESERTA DIDIK</h3>
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a href="<?= base_url('/sekolah/gallery/tambah'); ?>" class="btn btn-success"><i class="fas fa-plus"></i> TAMBAH AKUN</a>
                <table id="example2" class="table table-sm table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?= base_url('/sekolah/cetaksiswa/imam'); ?>" target="_blank" class="mx-1 my-1 btn btn-sm btn-danger">HAPUS</a>
                    </td>
                  </tr>
                  </tbody>
                  <tfoot>
